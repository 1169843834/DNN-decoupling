...
%% ===================== Step 6: Plot regression curves ===============
figure('Name','Regression Comparison','Color','w'); 
...
saveas(gcf, 'Regression_Comparison_PTonly.png');
...
writetable(T_metrics, 'Decoupling_Metrics_PTonly.xlsx', 'Sheet','Error_Comparison');

disp('=== Error Comparison Across Subsets (Before vs After Decoupling) ===');
disp(T_metrics);

fprintf("✅ Decoupling completed. Results saved as 'Decoupling_Metrics_PTonly.xlsx'\n");
